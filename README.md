...
<div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
  <img src="screenshots/fabric/Fabric.png" width="30" style="display: block;" />
  <span>The project was developed entirely in <strong>Microsoft Fabric</strong> and <strong>Power BI</strong> (no VS Code used). Here's the technical architecture:</span>
</div>
