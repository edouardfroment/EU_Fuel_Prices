...
<img src="screenshots/fabric/Fabric.jpg" width="2%"/> The project was developed entirely in **Microsoft Fabric** and **Power BI** (no VS Code used). Here's the technical architecture:
